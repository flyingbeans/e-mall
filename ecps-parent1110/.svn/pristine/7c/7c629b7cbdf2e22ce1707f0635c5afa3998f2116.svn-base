...
$(function(){
	...
	$("#addItemNoteConfirm").click(function(){
		...
		window.location.href= "${path}/order/call.do?orderId="+orderId;
	})
});
	...
	<div class="frameR"><div class="content">
				...
				<form id="myForm" action="${path}/order/orderPay/oper.do"
					...
					<div class="sch page_c">
						<span class="l">订单号：<b class="red"><var>${order.orderNum}</var></b>&nbsp;&nbsp;&nbsp;下单时间：<var><fmt:formatDate value="${order.orderTime}" pattern="yyyy-MM-dd HH:mm:ss" /></var>&nbsp;&nbsp;&nbsp;<b class="f14 blue"></b>&nbsp;&nbsp;&nbsp; 
