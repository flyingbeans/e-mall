 ...
 * generated in the com.sihai.ecps.ws.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _PublishItemResponse_QNAME = new QName("http://service.ws.ecps.sihai.com/", "publishItemResponse");
    private final static QName _PublishItem_QNAME = new QName("http://service.ws.ecps.sihai.com/", "publishItem");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.sihai.ecps.ws.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.ecps.sihai.com/", name = "publishItemResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.ecps.sihai.com/", name = "publishItem")
