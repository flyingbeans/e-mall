...
public class EbItem {
     ...
     *
     * @mbggenerated Wed Feb 22 16:02:58 CST 2017
     */
    private Long itemId;
    ...
    private EbItemClob itemClob;//商品对大字段一对一
    private List<EbParaValue> paraList;//商品对商品普通属性一对多
    private List<EbSku> skuList;//商品对商品最小销售单元一对多
